namespace Maaaaa.Asn.Editor
{
    internal static class AsnText
    {
        ...
        public const string MissingScriptRepairWarning = "Missing Script の m_Script を YAML で直接書き換えます。Unity 2022.3 の実機検証では、同じ型への復帰で既存値が保持されました。別型では同名・同型フィールドの値だけが引き継がれ、対応しない値は次回保存時に YAML から除去されました。必ずバックアップを確認してください。";
